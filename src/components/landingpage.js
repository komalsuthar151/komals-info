        ...
        <Grid className="landing-grid home">
          <Cell col={8}>
            <div >
              ...
              <p style={{margin:'auto', padding:'5px', fontFamily:'Verdana, sans-serif'}}>I am a passionate web developer. Checkout my work. Feel free to sent a message or just 'Hi'. I would love to hear your feedback.</p>
              ...
              <Cell col={4}>
              <img src="https://lh3.googleusercontent.com/G2Sh3ReoAOadqTIfw6iC-JIjn68cAH2DmRFhSL6wst6cLE1Tsu01J9BcKCrqMcCFVk6KlbUO-GgjE-wOUjQAp3xKkHM-PQB1asr80uyiML1cTiRDs9XQr6BQ-v9eI8hBoz7B_L0tihU=w398-h315-p-k" /> 
            </Cell>
